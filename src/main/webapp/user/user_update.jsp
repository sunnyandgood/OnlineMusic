                ...
                <div class="ibox-content">
                    <form  class="form-horizontal" method="post">
                        <c:forEach var="userBean" items="${userBeans }">
                            ...
                            <input type="hidden" class="form-control"  name="user_password" value="<c:out value="${userBean.user_password}"/>">

                            <input type="hidden" name="vip_id" value="<c:out value="${userBean.vip_id }" />"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"  name="user_gender" value="<c:out value="${userBean.user_gender}"/>">
                                </div>
                            </div>
...
<script>
    var vipIdOld = $('[name=vipIdOld]').val();
    var typeIdOld = $('[name=typeIdOld]').val();

    // layer.msg(vipIdOld);
    // layer.msg(typeIdOld);
    //
    // $("input:radio[value=vipIdOld]").attr('checked','true');
